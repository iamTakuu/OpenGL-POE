...
int main()
{
	...
	glm::vec3 light_pos = glm::vec3(0.5f, 5.0f, -5.5f);
	glm::mat4 light_model = glm::mat4(1.0f);
	light_model = glm::translate(light_model, light_pos);

	// Set the light properties in the shader
	glUniform4f(glGetUniformLocation(default_shader.ID, "lightColor"), light_color.x, light_color.y, light_color.z, light_color.w);
	glUniform3f(glGetUniformLocation(default_shader.ID, "lightPos"), light_pos.x, light_pos.y, light_pos.z);
	...
	// Create the board with 64 cubes
	Board board(64);
	// Camera
...
#pragma endregion
	...
	Model rook_model ("Models/Rook.obj");
	rook_model.transform.setLocalPosition( glm::vec3(0.0f, 4.0f, 0.0f));
	rook_model.transform.setLocalRotation( glm::vec3(30.0f, 0.0f, -20.0f));

	Model queen_model ("Models/Queen.obj");
	queen_model.transform.setLocalPosition( glm::vec3(8.0f, 2.0f, -2.0f));
	queen_model.transform.setLocalRotation( glm::vec3(-43.0f, 0.0f, 40.0f));

	Model knight_model ("Models/Knight.obj");
	knight_model.transform.setLocalPosition( glm::vec3(-5.0f, 3.8f, 4.0f));
	knight_model.transform.setLocalRotation( glm::vec3(12.0f, 0.0f, 72.0f));
	...
	while (!glfwWindowShouldClose(window))
	{
		...
		rook_model.Draw(default_shader, camera);
		queen_model.Draw(default_shader, camera);
		knight_model.Draw(default_shader, camera);
